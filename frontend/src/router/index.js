...
const routes = [
  ...
  { path: "/geo", name: "Geo", component: () => import("../views/StationView.vue"), meta: { auth: true, layout: 'main' } },
  { path: "/geo/:id(\\d+)", name: "GeoSingle", component: () => import("../views/GeoSingleView.vue"), meta: { auth: true, layout: 'main' } },
